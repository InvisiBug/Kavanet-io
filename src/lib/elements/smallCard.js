...
const SmallCard = ({
  ...
  return (
    <>
      <div className="container flex w-72 m-auto h-96 overflow-hidden mt-10 justify-center items-center  dark:bg-gray-600 border border-gray-200 shadow-lg rounded-3xl">
