  ...
  return (
    <>
      <div className="container absolute top-0 left-0 right-0 z-50 mx-auto p-10 ">
        <div className="container flex md:max-w-5xl  mx-auto justify-center sm:justify-between bg-gray-800 rounded-2xl shadow-lg">
          <NavButton activeStyles={false} hoverStyles={false} to="/home">
            Kavanet.io
          </NavButton>

          <div className="hidden sm:flex justify-around mr-24">
